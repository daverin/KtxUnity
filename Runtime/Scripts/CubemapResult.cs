...
namespace KtxUnity {
    ...
    /// </summary>
    public class CubemapResult {
        public Cubemap texture;
        public TextureOrientation orientation;
        public ErrorCode errorCode = ErrorCode.Success;

        public CubemapResult() {}
        
        public CubemapResult(ErrorCode errorCode) {
            this.errorCode = errorCode;
        }

        public CubemapResult(Cubemap texture, TextureOrientation orientation) {
